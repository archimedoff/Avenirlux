    ...
    <div className="hotels-page page-enter pb-10">
      ...
      <div className="hotels-layout mt-8">
        <aside className="hidden lg:block">
          <div className="glass-card skeleton-shimmer h-96 w-full max-w-[280px] rounded-[var(--radius-card)]" />
        </aside>
        <ul className="hotels-results-grid flex-1">
          {Array.from({ length: 6 }).map((_, index) => (
            <li key={index} className="skeleton-card skeleton-shimmer overflow-hidden rounded-[var(--radius-card)]">
              <div className="skeleton-card__media aspect-[4/5]" />
